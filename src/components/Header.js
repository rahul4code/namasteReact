...
const Header = (props) => {
  ...
  return (
    <div className="flex justify-between pt-4 pb-4 shadow-lg">
      <div className="flex">
      <img alt="NoImg" className="h-12 pl-40 z-30 hover:scale-110 cursor-pointer" src={logoSwiggy} />
      <span className="flex  hover:text-orange-600 cursor-pointer">
      <p className="text-gray-800 text-base font-semibold pt-[9px] pl-10 hover:text-orange-600 cursor-pointer">Other</p>
      <p className="text-gray-600 text-sm pt-3 pl-2 hover: cursor-pointer">Lucknow, Uttar Pradesh, India</p>
